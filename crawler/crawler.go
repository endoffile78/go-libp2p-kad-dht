...
import (
	...
	wire "github.com/libp2p/go-libp2p-kad-dht/wire"
...
func (ms *messageSender) SendRequest(ctx context.Context, p peer.ID, pmes *pb.Message) (*pb.Message, error) {
	...
	defer cancel()
	defer func() { helpers.FullClose(s) }()
...
func queryPeer(ctx context.Context, host host.Host, dhtRPC *wire.ProtocolMessenger, nextPeer peer.ID) *queryResult {
